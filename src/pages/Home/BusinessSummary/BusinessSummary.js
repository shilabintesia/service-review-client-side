...
import summary from '../../../assets/images/customer-reviews.jpg'
    ...
    return (
        <div>
            <section className="our-facts">
                <div>
                    <h2 className='text-center'>A Few Facts About Our Restaurants</h2>
                    <div className='flex justify-center bg-gray-50 py-5'>
                                    ...
                                    <div className="grid lg:grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-5">
                                        ...
                                        <div>
                                            <div className="count-area-content new-students">
                                                <div className="count-digit"><CountUp end={1000} delay={1} duration={7} /></div>
                                        ...
                                        <div>
                                            <div className="count-area-content">
                                                ...
                                                <div className="count-title">Client Feedbacks
                        ...
                        <div>
                            <img className='w-96 mt-8 hidden rounded-3xl h-72 lg:block' src={summary} alt="" />
                        </div>
                    </div>
                </div>
            </section>
